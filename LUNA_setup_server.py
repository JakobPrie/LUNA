...
print('Willkommen zum Setup-Assistenten für deinen neuen Sprachassistenten.\n'
      'Im ersten Schritt geht es um die Einrichtung deines LUNA-Servers. \n'
...
system_name = input('\nBitte gib einen Namen für deinen Sprachassistenten ein (z.B. "LUNA", "Alexa" oder "J.A.R.V.I.S") '
