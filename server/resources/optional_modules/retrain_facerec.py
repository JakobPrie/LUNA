...
def handle(text, luna, local_storage):
    print('\n\n--------- RETRAIN --------')
    luna.say('Okay, warte einen Moment. Ich trainiere die Gesichtserkennung neu.')
    ...
    f = open(local_storage['LUNA_PATH'] + '/resources/face_encodings.pickle', "wb")
    f.write(pickle.dumps(data))
    f.close()

    print('[INFO] Gegenbeispiele werden ergänzt...')#
    unknown_data = pickle.loads(open(local_storage['LUNA_PATH'] +'/resources/face_encodings_unknown.pickle', 'rb').read())
    ...
    f = open(local_storage['LUNA_PATH'] + '/resources/face_recognizer', "wb")
    f.write(pickle.dumps(recognizer))
    f.close()

    # write the label encoder to disk
    f = open(local_storage['LUNA_PATH'] + '/resources/face_label_encoder.pickle', "wb")
    f.write(pickle.dumps(le))
    f.close()


    print('--------- FERTIG ---------\n\n')
    luna.say('Die Gesichtserkennung wurde neu trainiert.')
