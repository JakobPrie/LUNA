...
def handle(text, luna, profile):
    ...
    while on_going and len(fragen) > 0:
            ...
            if item["Frage"] != "":
                ...
                if item["Audio"] != "":
                    ...
                    try:
                        ...
                        luna.say \
                            ("Leider gab es ein Problem beim Abspielen einer Audio-Datei. Daher machen wir einfach mit der n#chsten Frage weiter!")
                        fragen.remove(item)
        ...
        # Da bei einer nicht direkten Antwort ein TIMEOUT_OR_INVALID kommt, machen wir einfach eine Schleife, irgendwann
        # wird der Ntuzer schon antworten
        user_response = "TIMEOUT_OR_INVALID"
        ...
        if 'abbruch' in user_response or 'stopp' in user_response or \
            ...
            if insgesamt == 0:
                ...
                luna.say("Okay, Quiz beendet. Du hast {} Fragen beantwortet, davon waren {}% richtig".format(insgesamt,
                                                                                                             round(
            ...
            for letter in richtige_antwort:
                # for letter in response und nicht for letter in antwort
...
if __name__ == "__main__":
    class Luna:
        def __init__(self):
            ...
            self.user = 'Baum'
            self.path = "."
            self.analysis = {'room': 'None',
                             'time': {'month': '10', 'hour': '10', 'year': '2010', 'minute': '00', 'day': '09'},
                             'town': 'None'}
    ...
    def test():
        ...
        handle("starte quiz zu allgemeinwissen", luna, profile)
